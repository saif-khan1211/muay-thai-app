...
SECRET_KEY = 'django-insecure-b*xo&aae)s=u69b1-(t_-*c(0^i6%7ly@*!p345qm0$*)-jmmw'
...
STRAVA_CLIENT_ID = os.getenv('STRAVA_CLIENT_ID', '130536')
STRAVA_CLIENT_SECRET = os.getenv('STRAVA_CLIENT_SECRET', 'becc02222371e11795bf63e4a5424074e4d42bdf')
STRAVA_CODE = os.getenv('STRAVA_CODE', '75fcccaa51d02c6969ab7fb5f26e2db8d0652583')
